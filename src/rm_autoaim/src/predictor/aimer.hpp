...
class Aimer
{
 private:
  ...
  double bullet_area_ = 2 * M_PI * (nerv::rm_data::BULLET_17_DIAMETER / 2) *
                        (nerv::rm_data::BULLET_17_DIAMETER / 2);  // 子弹横截面积，单位：mm^2
  double bullet_mass_ = nerv::rm_data::BULLET_17_MASS;            // 子弹质量，单位：g
 ...
 public:
  ...
  void bullet_type(nerv::rm_data::BulletType bullet_type);
